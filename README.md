...
Here I have added the work "Sherlock Holmes" for more possible tokens. Also, I left whitespaces in the text, increased the length of tokens and changed the code a bit. As a result I got a text, in which we can see very meaningful chains of words. File: [generator2.py]().

## Conclusion

* I was able to make a program that predicts the following letters!
